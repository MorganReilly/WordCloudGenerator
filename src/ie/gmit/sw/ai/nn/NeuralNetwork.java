...
public class NeuralNetwork {
	...
	public NeuralNetwork(Activator.ActivationFunction function, int num_input_nodes, int num_hidden_nodes,
	...
	public double[] process(double[] data_inputs) throws Exception {
		...
		if (data_inputs.length != inputs.length) {
			throw new Exception("Invalid input for a " + inputs.length + "x" + hidden.length + "x" + outputs.length
					+ " neural network.");
		}
